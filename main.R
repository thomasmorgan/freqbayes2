...
# Don't worry about these, as the simulations run, they will be
...
for (rep in 1:n_repeats) {
  ...
  data_sets <- data.frame(data_set, participant_id, sex, condition, response)
  rm(data_set, participant_id, sex, condition, response)
